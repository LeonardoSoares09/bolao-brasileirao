...
/* Prazo do lembrete de PAGAMENTO — campo separado do artilheiro (era
   reaproveitado, agora não é mais): trava no início da rodada 20, mais cedo
   de propósito, pra cobrar o pix logo no começo do turno em vez de só perto
   do prazo do artilheiro. Mesma mecânica: NULL até essa rodada existir em
   `jogos` (api/estado.js). */
export const RODADA_LIMITE_PAGAMENTO = 20;
